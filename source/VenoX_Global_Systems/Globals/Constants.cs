...
namespace VnXGlobalSystems.Globals
{
    ...
    {
        public const string VNXGLOBALSYSTEMSVERSION = "V.1.1.7";                //VenoX Global Systems Version.
        ...
        // Cheat Check
        public const int TELEPORT_KICK_FOOT = 20;                            //Distance in Meter ( Kick after ...meter+ on Foot).
        public const int TELEPORT_KICK_VEHICLE = 50;                         //Distance in Meter ( Kick after ...meter+ in Vehicle).
        public const int TELEPORT_KICK_FLYVEHICLE = 70;                    //Distance in Meter ( Kick after ...meter+ in Vehicle).
        ...
        public static List<AltV.Net.Enums.VehicleModel> Helicopter = new List<AltV.Net.Enums.VehicleModel>
        {
            ...
            AltV.Net.Enums.VehicleModel.Polmav,
