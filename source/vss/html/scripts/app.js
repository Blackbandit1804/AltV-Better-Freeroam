...
let app = new Vue({
    ...
    data: {
        ...
        models: [
			...
			{ category: 1, model: 'dinghy5' },
			{ category: 1, model: 'kosatka' },
			{ category: 1, model: 'patrolboat' },
			{ category: 1, model: 'longfin' },
			...
			{ category: 3, model: 'weevil' },
            { category: 3, model: 'blista' },
            { category: 3, model: 'brioso' },
			{ category: 3, model: 'brioso2' },
			...
			{ category: 7, model: 'annihilator2' },
            { category: 7, model: 'seasparrow2' },
            { category: 7, model: 'seasparrow3' },
			...
			{ category: 12, model: 'winky' },
			{ category: 12, model: 'verus' },
			...
			{ category: 17, model: 'veto' },
            { category: 17, model: 'veto2' },
            { category: 17, model: 'italirsx' },
			...
			{ category: 20, model: 'trailerscola' },
